...
import os
from Scrolling_Background import Background
...
red = pygame.image.load(resource_path(r"ufo_bakr.png"))
hit = pygame.mixer.Sound(resource_path("hit.wav"))
white_barrier = pygame.mixer.Sound(
    resource_path("white barrier.wav"))
...
class Projectile:
    def __init__(self, screen,  y):
        ...
        self.ys = [self.y, self.y1, self.y2, self.y3, self.y4,
                   self.y5, self.y6, self.y7, self.y8, self.y9]
        self.screen = screen
        # Player projectile model
        self.laser_sideways = pygame.image.load(
            resource_path("shot.png"))
        self.laser = pygame.transform.rotate(self.laser_sideways, 90)

    def draw_projectile(self):
        self.screen.blit(self.laser_sideways, (self.four +
                         self.difference, self.ys[self.num]))
...
class Player:
    def __init__(self, x, y, screen):
        ...
        self.health = 5
        self.screen = screen
        self.scroll = Background(self.screen)
        # Player model
        self.shooter = pygame.image.load(
            resource_path("Iron man.png"))
        self.x = x
        self.y = y
...
class Enemies:
    def __init__(self, screen):
        ...
        self.ship = pygame.image.load(resource_path("ufo.png"))
        # ys of the enemies
        self.y = 20
        self.y1 = 20
        self.y2 = 20
        ...
        self.sky = pygame.image.load(
            resource_path("Background.png"))
        self.ships = [self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship,
                      self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship, self.ship,]
        # xs of the enemies
        self.x = 200 + 50
        self.x1 = 255 + 50
        self.x2 = 310 + 50
        ...
        self.laserx = 200 + 50 + 0
        self.laserx1 = 255 + 50 + 0
        self.laserx2 = 310 + 50 + 0
        self.laserx3 = 365 + 50 + 0
        self.laserx4 = 420 + 50 + 0
        self.laserx5 = 475 + 50 + 0
        self.laserx6 = 50 + 200 + 0
        self.laserx7 = 50 + 310 + 0
        self.laserx8 = 50 + 365 + 0
        self.laserx9 = - 400000000
        self.laserx10 = 475 + 50 + 0
        self.laserx11 = 250 + 0
        self.laserx12 = 525 + 0
        ...
        self.horde_y = [self.y, self.y1, self.y2, self.y3, self.y4, self.y5, self.y6, self.y7, self.y8, self.y9, self.y10, self.y11, self.y12,
                        self.y13, self.y14, self.y15, self.y16, self.y17, self.y18, self.y19, self.y20, self.y21, self.y22, self.y23, self.y24, self.y25]
        self.horde_x = [self.x, self.x1, self.x2, self.x3, self.x4, self.x5, self.x6, self.x7, self.x8, self.x9, self.x10, self.x11, self.x12,
                        self.x13, self.x14, self.x15, self.x16, self.x17, self.x18, self.x19, self.x20, self.x21, self.x22, self.x23, self.x24, self.x25]
        self.laserxs = [self.laserx, self.laserx1, self.laserx2, self.laserx3, self.laserx4, self.laserx5, self.laserx5, self.laserx6, self.laserx7, self.laserx8, self.laserx9, self.laserx10, self.laserx11,
                        self.laserx12, self.laserx13, self.laserx14, self.laserx15, self.laserx16, self.laserx17, self.laserx18, self.laserx19, self.laserx20, self.laserx21, self.laserx22, self.laserx23, self.laserx24, self.laserx25]
        self.downs = [self.down, self.down1, self.down2, self.down3, self.down4, self.down5, self.down6, self.down7, self.down8, self.down9, self.down10, self.down11, self.down12,
                      self.down13, self.down14, self.down15, self.down16, self.down17, self.down18, self.down19, self.down20, self.down21, self.down22, self.down22, self.down23, self.down24, self.down25]
        self.status = [True, True, True, True, True, True, True,
        ...
        self.line = {self.horde_y[0]: True, self.horde_y[1]: True, self.horde_y[2]: True, self.horde_y[3]: True, self.horde_y[4]: True, self.horde_y[5]: True,
                     self.horde_y[6]: True, self.horde_y[7]: True, self.horde_y[8]: True, self.horde_y[9]: True, self.horde_y[10]: True, self.horde_y[11]: True, self.horde_y[12]: True}
        self.line2 = {self.horde_y[13]: True, self.horde_y[14]: True, self.horde_y[15]: True, self.horde_y[16]: True, self.horde_y[17]: True, self.horde_y[18]: True,
                      self.horde_y[19]: True, self.horde_y[20]: True, self.horde_y[21]: True, self.horde_y[22]: True, self.horde_y[23]: True, self.horde_y[24]: True, self.horde_y[25]: True}
        self.list_line1 = []
        self.list_line2 = []
        self.scroll = Background(self.screen)
        if self.level == 2:
            ...
            for i in range(0, 14):
                self.laserxs[i] = self.horde_x[i] + 0
        if self.level == 3:
            position = 80
            position2 = 365
            for i in range(0, 12):
                ...
                if 6 <= i <= 11:
                    ...
                    if i % 2 == 1:
                        self.horde_x[i] = 830
                if i <= 5:
                    self.horde_y[i] = position
                    if i % 2 == 1:
                        position += 60
                if 6 <= i <= 11:
                    self.horde_y[i] = self.horde_y[i-6]
            for i in range(12, 14):
                self.horde_x[i] = position2
                self.horde_y[i] = position + 50
                position2 += 80
        ...
        if self.level == 4:
            if 1 == 1:
                ...
                self.status = [True, True, True, True, True, True,
    ...
    def platform_placement(self, x1, y1, x_extension, y_extension):
        pygame.draw.rect(self.screen, (200, 200, 200), [
                         x1, y1, x_extension, y_extension])

    def green_platform_placement(self, x1, y1, x_extension, y_extension):
        pygame.draw.rect(self.screen, (221, 160, 221), [
                         x1, y1, x_extension, y_extension])
    ...
    def level1(self):
        ...
        match self.level:
            case 1:
                for i in range(0, 13):
                    ...
                    if self.horde_y[i] < 900:
                        self.ship_placement(
                            self.ships[i], self.horde_x[i], self.horde_y[i])
                self.platform_placement(200, 320, 90, 5)
                self.platform_placement(650, 320, 90, 5)
            ...
            case 3:
                for i in range(0, 14):
                    if i <= 11:
                        self.ship_placement(
                            self.ship, self.horde_x[i], self.horde_y[i])
                    else:
                        self.ship_placement(red, self.horde_x[i], self.horde_y[i])
                    self.platform_placement(400, 400, 100, 5)
            case 4:
                ...
                for i in range(0, 14):
                    ...
                    if self.horde_y[i] < 900:
                        if i == 7 or i == 8 or i == 0 or i == 1:
                            self.ship_placement(
                                red, self.horde_x[i], self.horde_y[i])
                        else:
                            self.ship_placement(
                                self.ship, self.horde_x[i], self.horde_y[i])
                ...
                for i in range(0, 26):
                    ...
                    if self.horde_y[i] < 900:
                        if i == 7 or i == 8 or i == 0 or i == 1:
                            ...
                            self.ship_placement(
                                self.ship, self.horde_x[i], self.horde_y[i])
                font7 = pygame.font.SysFont(
                    "Comic Sans", 25, bold=False, italic=False)
                score = font7.render(
        ...
        if (self.level/0.5) % 2 == 1:
            self.scroll.move(1, self.sky)
            green = (211, 175, 55)
            y = sine(100, 1280, 10, 50)
            y1 = sine(100, 1280, 10, 220)
            font1 = pygame.font.SysFont(
                "Comic Sans", 100, bold=False, italic=False)
            line = font1.render("Success", True, (149, 2, 18))
            ...
            font2 = pygame.font.SysFont(
                "Comic Sans", 75, bold=False, italic=False)
            if self.level != 5.5:
                line2 = font2.render("Continue?", True, (green))
            else:
                line2 = font2.render("Main Menu", True, green )
...
class Game:
    def __init__(self):
        ...
        self.blastssss = pygame.image.load(
            resource_path("enemy_shot.png"))
        self.blast = pygame.transform.rotate(self.blastssss, 180)
        self.backup = 0
        ...
        icon = pygame.image.load(resource_path("Iron.png"))
        pygame.display.set_caption("Iron-Man: Protector of Earth")
        pygame.display.set_icon(icon)
        self.scroll = Background(self.screen)
        # Instances of the above classes
        self.player = Player(self.screen_x/2 - 40,
                             self.screen_y - 80, self.screen)
        self.projectile = Projectile(self.screen, self.player.y - 10)
        ...
        # list of said ys
        self.laser_ys = [self.laser_y, self.laser_y1, self.laser_y2, self.laser_y3, self.laser_y4, self.laser_y5, self.laser_y6, self.laser_y7, self.laser_y8, self.laser_y9, self.laser_y10, self.laser_y11, self.laser_y12,
    ...
    def title(self):
        ...
        while title:
            ...
            image = pygame.image.load(
                resource_path("Iron.png"))
            y1 = sine(100, 1280, 5, 20)
            y2 = sine(100, 1280, 10, 270)
            y3 = sine(100, 1280, 10, 380)
            if save.check_file("level"):
                y4 = sine(100, 1280, 10, 490)
            else:
                y4 = sine(100, 1280, 5, 380)
            y5 = sine(100, 1280, 10, 150)
            green = (149, 2, 18)
            color = (149, 2, 18)  # Yellow
            color1 = (211, 175, 55)
            self.scroll.move(2, self.sky)
            pygame.draw.rect(self.screen, (211, 175, 155), [0, 250, 900, 5])
            font1 = pygame.font.SysFont(
                "Comic Sans", 100, bold=False, italic=False)
            font2 = pygame.font.SysFont(
                "Comic Sans", 75, bold=False, italic=False)
            ...
            if 250 <= mouse_x <= 250 + 400 and 280 <= mouse_y <= 430 - 50:
                ...
                green = (211, 175, 55)
            # The continue button is only drawn if a save file exists
            line = font1.render("Iron-Man", True, (149, 2, 18))
            line4 = font2.render("Protector of Earth", True, (211, 175, 55))
                ...
                if 320 <= mouse_x <= 320 + 300 and 380 + 10 <= mouse_y <= 590:
                    ...
                    if pygame.mouse.get_pressed() != (0, 0, 0):
                        if self.enemies.level != 0:
                            ...
                            self.reset()
                        title = False
            self.screen.blit(image, (300 + 50 + 100, y1))
            self.screen.blit(self.enemies.ship, (290, y5))
            self.screen.blit(red, (650, y5))
            line3 = font2.render("Endless", True, (color1))
            self.screen.blit(line1, (270, y2))
            self.screen.blit(line, (240, y))
            self.screen.blit(line4, (100 + 50, 150))
    ...
    def reset(self):
        ...
        if self.enemies.level == 1:
            ...
            self.enemies.horde_y[11] = 80 + 50 + 40
            self.enemies.horde_y[12] = 80 + 50+40
            self.enemies.horde_y[13] = 20
            self.enemies.horde_y[14] = 20
            self.enemies.horde_x[0] = 200 + 50 + 15
            self.enemies.horde_x[1] = 255 + 50+15
            self.enemies.horde_x[2] = 310 + 50+15
            self.enemies.horde_x[3] = 365 + 50+15
            self.enemies.horde_x[4] = 420 + 50+15
            self.enemies.horde_x[5] = 475 + 50+15
            self.enemies.horde_x[6] = 50 + 200+15
            self.enemies.horde_x[7] = 50 + 310+15
            self.enemies.horde_x[8] = 50 + 365+15
            self.enemies.horde_x[10] = 475 + 50+15
            self.enemies.horde_x[11] = 250+15
            self.enemies.horde_x[12] = 525+15
            self.enemies.horde_x[14] = 50+15
            for i in range(0, 15):
                self.enemies.laserxs[i] = self.enemies.horde_x[i] + 0
        if 1.5 <= self.enemies.level <= 2:
            ...
            for i in range(4, 8):
                self.enemies.horde_y[i] = 80 + 40
                self.enemies.horde_x[i] = 350 + (60*(i-4))
            for i in range(8, 11):
                self.enemies.horde_y[i] = 140 + 80
        ...
        if 2.5 <= self.enemies.level <= 3:
            ...
            for i in range(0, 14):
                if i <= 5:
                    if i % 2 == 0:
                        self.enemies.horde_x[i] = 20
                    if i % 2 == 1:
                        self.enemies.horde_x[i] = 100
                if 6 <= i <= 11:
                    if i % 2 == 0:
                        self.enemies.horde_x[i] = 750
                    if i % 2 == 1:
                        self.enemies.horde_x[i] = 830
                if i <= 5:
                    self.enemies.horde_y[i] = position
                    if i % 2 == 1:
                        position += 60
                if 6 <= i <= 11:
                    self.enemies.horde_y[i] = self.enemies.horde_y[i-6]
        ...
        pygame.mixer.music.play(-1)
        self.enemies.status = [True, True, True, True, True, True,
                               True, True, True, True, True, True, True, True, True]
        self.count = 0
    ...
    def play(self):
        ...
        if self.enemies.shot:
            ...
            for i in range(0, 26):
                if self.enemies.downs[i]:
                    self.screen.blit(
                        self.blast, (self.enemies.laserxs[i], self.laser_ys[i]))
        ...
        if self.up:
            ...
            if self.projectile.ys[self.projectile.num] > 350:
                self.player.shooter = pygame.image.load(resource_path("Iron man_right.png"))
            else:
                self.player.shooter = pygame.image.load(resource_path("Iron man.png"))
            ...
            if self.enemies.level == 0:
                ...
                if save_highscore.check_file("highscore"):
                    ...
                    if self.enemies.score > r:
                        save_highscore.save_game(
                            self.enemies.score, "highscore")
        if self.player.health == 0:
            raise GameOver
        for i in range(0, 26):
            if self.enemies.level != 0 and self.enemies.level < 3:
                if self.enemies.level ==1:
                        if i == 9 or i ==13:
                            continue
        ...
        for i in range(0, 26):
            if self.enemies.level > 3 or self.enemies.level == 0:
                    if self.alien_laser_collision(435 + self.projectile.difference, self.projectile.ys[self.projectile.num],
                            ...
                            elif i != 8 and i != 7 and i != 1 and i != 0:
                                    self.enemies.horde_y[i] = 1000
        ...
        for i in range(0, 13):
            ...
            if self.red_laser_collision(self.player.x, self.player.y, self.enemies.laserxs[i], self.laser_ys[i]):
                ...
                self.laser_ys[i] = 625
        pygame.display.update()
        match self.enemies.level: 
            case 1:
                # Enemy fire on barrier collision
                for i in range(0, 13):
                    if i == 9:
                        continue
                    if self.red_white_collision(200, 320, self.enemies.laserxs[i], self.laser_ys[i], 90):
                        self.laser_ys[i] = 625
                        pygame.mixer.Sound.play(white_barrier)
                for i in range(0, 13):
                    if i == 9:
                        continue
                    if self.red_white_collision(650, 320, self.enemies.laserxs[i], self.laser_ys[i], 90):
                        self.laser_ys[i] = 625
                        pygame.mixer.Sound.play(white_barrier)
                # Player fire on barrier collision
                if self.blue_light_collision(200, 320, 435 + self.projectile.difference, self.projectile.ys[self.projectile.num], 90):
                    self.projectile.ys[self.projectile.num] = -25
                    pygame.mixer.Sound.play(pygame.mixer.Sound(
                        resource_path("white barrier.wav")))
                if self.blue_light_collision(650, 320, 435 + self.projectile.difference, self.projectile.ys[self.projectile.num], 90):
                    self.projectile.ys[self.projectile.num] = -25
                    pygame.mixer.Sound.play(pygame.mixer.Sound(
                        resource_path("white barrier.wav")))
                ...
                for i in range(0, 14):
                    if self.alien_laser_collision(435 + self.projectile.difference, self.projectile.ys[self.projectile.num], self.enemies.horde_x[i], self.enemies.horde_y[i]):
                        if i == 12:
                            ...
                            self.projectile.ys[self.projectile.num] = -26
                            pygame.mixer.Sound.play(explosion)
                    if self.red_white_collision(400, 400, self.enemies.laserxs[i], self.laser_ys[i], 100):
                        self.laser_ys[i] = 625
                        pygame.mixer.Sound.play(white_barrier)
                if self.blue_light_collision(400, 400, 435 + self.projectile.difference, self.projectile.ys[self.projectile.num], 100):
                    self.projectile.ys[self.projectile.num] = -25
                    pygame.mixer.Sound.play(white_barrier)
                if self.red_laser_collision(self.player.x, self.player.y, self.enemies.laserxs[9], self.laser_ys[9]):
                    self.player.health -= 1
    ...
    def game_over(self):
        ...
        while over:
            ...
            if self.enemies.level != 0:
                ...
                x = 135
            font1 = pygame.font.SysFont(
                "Comic Sans", 110, bold=False, italic=False)
            font2 = pygame.font.SysFont(
                "Comic Sans", 75, bold=False, italic=False)
            if self.enemies.level != 0:
                ...
                line = font1.render(
                    f"Highscore: {str(save_highscore.load('highscore'))}", True, (200, 0, 0))
        ...
        while self.run:
            ...
            if self.enemies.level == 3:
                for i in range(0, 12):
                    if i <= 5:
                        self.enemies.horde_x[i] -= speed
                        if self.enemies.horde_x[i] <= 0:
                            self.enemies.horde_x[i] = 900
                    elif i <= 11:
                        self.enemies.horde_x[i] += speed
                        if self.enemies.horde_x[i] >= 900:
                            self.enemies.horde_x[i] = 0
                for i in range(12, 14):
                    if self.direction == "right":
                        self.enemies.horde_x[i] += speed
                    if self.direction == "left":
                        self.enemies.horde_x[i] -= speed
                if self.direction == "right":
                    if self.enemies.horde_x[12] >= 770:
                        if self.enemies.horde_y[12] <= 800:
                            self.direction = "left"
                    if self.enemies.horde_y[13] <= 800:
                        if self.enemies.horde_x[13] >= 820:
                            self.direction = "left"
                if self.direction == "left":
                    if self.enemies.horde_x[12] <= 10:
                        if self.enemies.horde_y[12] <= 800:
                            self.direction = "right"
                    if self.enemies.horde_x[13] <= 60:
                        if self.enemies.horde_y[13] <= 800:
                            self.direction = "right"
            if self.enemies.level == 4:
